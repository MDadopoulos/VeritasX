...
Note: calculate, pct_change, sum_values are plain Python functions.
Call them directly: calculate("expr"), pct_change(old, new), sum_values(pairs, count).
"""
